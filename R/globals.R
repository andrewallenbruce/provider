...
utils::globalVariables(c(
  ...
  "Tot_Benes", # <provider_mpop_serv>
  "Tot_Srvcs", # <provider_mpop_serv>
  "Tot_Bene_Day_Srvcs", # <provider_mpop_serv>
  "Avg_Sbmtd_Chrg", # <provider_mpop_serv>
  "Avg_Mdcr_Alowd_Amt", # <provider_mpop_serv>
  "Avg_Mdcr_Pymt_Amt", # <provider_mpop_serv>
  "Avg_Mdcr_Stdzd_Amt", # <provider_mpop_serv>
  "Year", # <provider_mpop_serv>
