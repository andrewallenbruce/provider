...
column_renames <- function(endpoint) {
  switch(
    ...
    clia = c(
      ...
      RELATED_PROVIDER_NUMBER = "related_ccn",
      CROSS_REF_PROVIDER_NUMBER = "xref",
      CHOW_CNT = "chown",
      CHOW_DT = "chowd",
      CHOW_PRIOR_DT = "chowd_2",
      ACPTBL_POC_SW = "poc",
      ...
      DRCTLY_AFLTD_LAB_CNT = "naff",
      MLT_SITE_EXCPTN_SW = "multi",
      HOSP_LAB_EXCPTN_SW = "hosp",
      NON_PRFT_EXCPTN_SW = "nprof",
      LAB_TEMP_TSTG_SITE_SW = "temp",
      LAB_SITE_CNT = "nsites",
      SHR_LAB_SW = "shr_lab",
      SHARED_LAB_XREF_NUMBER = "shr_xref",
      FY_END_MO_DAY_CD = "fy",
      INTRMDRY_CARR_CD = "macc",
      INTRMDRY_CARR_PRIOR_CD = "macp",
      MDCD_VNDR_NUM = "vend",
