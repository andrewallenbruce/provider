...
pivot_subgroup <- function(x) {
  ...
  collapse::recode_char(
    y[["sub_group"]],
    "acute_ind" = "Acute Care Hospital",
    "gen_ind" = "General",
    "spec_ind" = "Specialty",
    "adu_ind" = "Alcohol-Drug Unit",
    "child_ind" = "Children's Hospital",
    "ltc_ind" = "Long-Term Care Hospital",
    "psy_ind" = "Psychiatric Hospital",
    "irf_ind" = "Inpatient Rehabilitation Facility",
    "stc_ind" = "Short-Term Care Hospital",
    "sba_ind" = "Swing-Bed Unit",
    "psu_ind" = "Inpatient Psychiatric Unit",
    "iru_ind" = "Inpatient Rehabilitation Unit",
    "other_ind" = "Other",
    default = NA_character_,
    set = TRUE
  )
