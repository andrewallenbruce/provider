...
renames <- function(endpoint) {
  switch(
    ...
    laboratories = c(
      ...
      ELGBLTY_SW = "eligible_ind",
      FAC_NAME = "name",
      INTRMDRY_CARR_CD = "mac_curr",
      MDCD_VNDR_NUM = "vend",
      ORGNL_PRTCPTN_DT = "orig_date",
      CHOW_PRIOR_DT = "chow_prev_date",
      ...
      CLIA_TRMNTN_CD = "term_cd",
      ACRDTN_SCHDL_CD = "sched_cred",
      FORM_116_ACRDTD_TEST_VOL_CNT = "vol_cred",
      FORM_116_TEST_VOL_CNT = "vol_comp",
      DRCTLY_AFLTD_LAB_CNT = "aff_count",
      ...
      LAB_SITE_CNT = "site_count",
      PPMP_TEST_VOL_CNT = "vol_ppm",
      ADDTNL_FAC_NAME = "name_2",
      RELATED_PROVIDER_NUMBER = "rel_num",
      SHR_LAB_SW = "shared_lab",
      SHARED_LAB_XREF_NUMBER = "shared_xref",
      FORM_1557_CRTFCT_SCHDL_CD = "sched_cert",
      FORM_1557_CMPLNC_SCHDL_CD = "sched_comp",
      FORM_1557_TEST_VOL_CNT = "vol_surv",
      WVD_TEST_VOL_CNT = "vol_waive"
    ),
    providers = c(
      NPI = "npi",
