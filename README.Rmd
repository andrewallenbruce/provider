...
mooa_ex |> dplyr::select(
  ...
  provider::age_days(start_date = optout_end_date, end_date = lubridate::today()) |> 
...
```{r echo=FALSE}
mpop_geo_99214 |> dplyr::select(Year = year,
                             HCPCS = hcpcs_cd,
                             ...
                             "Avg Allowed" = avg_mdcr_alowd_amt, 
                             "Avg Payment" = avg_mdcr_pymt_amt, 
                             "Avg Standard Pymt" = avg_mdcr_stdzd_amt) |> knitr::kable()
```
