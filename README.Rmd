...
API Search functions can be grouped according to the type of data they return about a provider: *administrative*, *statistical*, and *auxiliary.*
...
### Auxiliary
   ...
   - `missing_endpoints()`: Is a provider missing Endpoints in the NPPES NPI Registry?
