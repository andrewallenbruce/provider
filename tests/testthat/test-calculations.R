test_that("change() works", {
  ...
  b <- dplyr::tibble(
    ...
    x_pct_ror = c(1, 1.03395, 0.80575, 1.29457, 0.78295, 1.62228),
    y_pct_ror = c(1, 0.61475, 1.16204, 0.94607, 1.01221, 0.81496),
    x_chg_csm = c(0L, 48L, -236L, 111L, -220L, 523L),
    y_chg_csm = c(0L, -700L, -519L, -589L, -574L, -804L),
    x_pct_csm = c(0, 0.03395, -0.16031, 0.13426, -0.08279, 0.53949),
    y_pct_csm = c(0, -0.38525, -0.22321, -0.27714, -0.26492, -0.44996),
  )
