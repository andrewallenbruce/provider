...
That returns three more affiliated individual providers that practice in the Hospital's nursing home. An alphanumeric CCN represents a sub-unit of a Hospital, here a Nursing Home. 

> We would get the same result if we'd set the `parent_ccn` argument to the numeric CCN, i.e. `facility_affiliations(parent_ccn = 331302)`
