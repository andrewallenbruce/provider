...
mpop20 <- provider_mpop(npi = 1760485387, year = "2020")
mpop19 <- provider_mpop(npi = 1760485387, year = "2019")
mpop18 <- provider_mpop(npi = 1760485387, year = "2018")
mpop17 <- provider_mpop(npi = 1760485387, year = "2017")
mpop16 <- provider_mpop(npi = 1760485387, year = "2016")
mpop15 <- provider_mpop(npi = 1760485387, year = "2015")
mpop14 <- provider_mpop(npi = 1760485387, year = "2014")
mpop13 <- provider_mpop(npi = 1760485387, year = "2013")

# Bind the data frames together by row
mpop_13_20 <- dplyr::bind_rows(mpop20, 
                               mpop19, 
                               mpop18, 
                               mpop17, 
                               mpop16, 
