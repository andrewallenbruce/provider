...
```{r}
open_payments(recipient_npi = 1043218118, year = 2020)
```

<br><br>

```{r}
open_payments(recipient_npi = 1043218118, year = 2019)
```
...
```{r}
open_payments(manufacturer_gpo_id = 100000151589, offset = 0)
```
<br><br>

```{r}
open_payments(manufacturer_gpo_id = 100000151589, offset = 500)
```
...
```{r}
open_payments(manufacturer_gpo_id = 100000151589, year = 2020)
```

<br><br>

```{r}
open_payments(manufacturer_gpo_id = "100000151589", year = 2019)
```

<br><br>

```{r}
open_payments(recipient_npi = 1346540572)
```
