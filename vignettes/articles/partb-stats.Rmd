...
ind     <- future_map_dfr(util_years(), ~utilization(year = .x, npi = 1043477615, type = "provider"))
...
srvc    <- future_map_dfr(util_years(), ~utilization(year = .x, npi = 1023076643, type = "service"))
