...
<details><summary>Beneficiary Demographics</summary>
<p>


```{r}
select(ind1, year, tot_benes, demographics) |> 
  unnest(demographics) |>
  ...
  sub_zero(zero_text = "") |>
  opt_all_caps() |> 
  gt_check_xmark(cols = c(tot_age_eq, tot_gen_eq, tot_dual_eq, verdict)) |> 
