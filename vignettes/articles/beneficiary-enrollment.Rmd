...
```{r}
beneficiary_enrollment(level = "State", period = "Month") |> head(10)
```
...
```{r}
beneficiary_enrollment(period = "Year", level = "State", state = "GA") |> head(10)
```
...
```{r}
beneficiary_enrollment(period = "Year", level = "County", state_name = "Georgia") |> head(10)
```

Or a particular county:

```{r}
beneficiary_enrollment(period = "Year", level = "County", state = "GA", county = "Lowndes") |> head(10)
```
