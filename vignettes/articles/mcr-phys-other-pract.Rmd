...
flextable(mpop_prov) |> autofit() |> ftExtra::colformat_md()
```
...
flextable(mpop_geo) |> autofit() |> ftExtra::colformat_md() |> theme_vanilla()
```
...
flextable(mpop_serv) |> autofit() |> ftExtra::colformat_md() |> theme_vanilla()
```

<br><br>

```{r eval=FALSE, include=FALSE}
mpop_serv <- readxl::read_excel("C:/Users/andyb/Desktop/Desktop Archive/provider_api_schemas.xlsx", sheet = "mpop_serv")
mpop_serv <- mpop_serv |> 
  dplyr::mutate(variable_name = stringr::str_to_lower(variable_name)) |> 
...
constructive::construct(mpop_serv)
```
