...
provider_enrollment(first_name = "Matthew", 
                    last_name = "Smith",
                    state = "FL") |> 
  dplyr::pull(enroll_id) |> 
  purrr::map(\(x) doctors_and_clinicians(enroll_id = x)) |> 
  purrr::list_rbind()
```
