...
geography |> 
  unnest(national, names_sep = ".") |> 
  unnest(statewide, names_sep = ".")
```


```{r}
by_geography(year = 2014, 
             sublevel = "New Hampshire", 
             hcpcs_code = "93010", 
             pos = "F") |> 
  mutate(avg_benes = tot_benes / tot_provs,
         avg_srvcs = tot_srvcs / tot_provs) |> 
  select(year, 
         sublevel, 
         hcpcs_code, 
         pos, 
