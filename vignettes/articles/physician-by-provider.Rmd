...
patchwork <- patchwork::wrap_plots(age, sex, race, dual) +
  patchwork::plot_annotation(
    title = 'Medicare Provider Demographics Overview: 2014 - 2021',
    caption = 'Source: Medicare',
    theme = ggplot2::theme(plot.title = ggplot2::element_text(size = 16)))

patchfile <- fs::path(knitr::fig_path(), "patchwork_prov.png")
ragg::agg_png(patchfile, width = 60, height = 36, units = "cm", res = 300, scaling = 3)
```
