...
#>  $ spec          : chr [1:5] "00-09" "00-09" "00-09" "00-09" ...
#>  $ specialty     : chr [1:5] "PART A PROVIDER - HOSPITAL" "PART A PROVIDER - HOSPITAL" "PART A PROVIDER - HOSPITAL" "PART A PROVIDER - HOSPITAL" ...
#>  $ npi           : chr [1:5] "1033270699" "1508845637" "1568419976" "1306849708" ...
...
#>  $ inc_date      : chr [1:5] "1926-01-01" "1984-03-01" "1995-01-01" "1904-10-26" ...
#>  $ inc_state     : chr [1:5] "NY" "VT" "VT" "VT" ...
#>  $ str           : chr [1:5] "CORPORATION" "CORPORATION" "CORPORATION" "CORPORATION" ...
#>  $ str_otxt      : chr [1:5] NA NA NA NA ...
#>  $ design        : chr [1:5] "N" "N" "N" "N" ...
...
#>  $ loc           : chr [1:5] "MAIN/PRIMARY HOSPITAL LOCATION" "MAIN/PRIMARY HOSPITAL LOCATION" "OTHER HOSPITAL PRACTICE LOCATION" "OTHER HOSPITAL PRACTICE LOCATION" ...
#>  $ loc_otxt      : chr [1:5] NA NA "HOSPITAL - GENERAL PRACTICE AND CLINICS" NA ...
#>  $ reh_ind       : chr [1:5] "N" "N" "N" "N" ...
#>  $ reh_date      : chr [1:5] NA NA NA NA ...
#>  $ sub_general   : chr [1:5] "N" "N" "N" "Y" ...
#>  $ sub_acute     : chr [1:5] "Y" "Y" "Y" "N" ...
