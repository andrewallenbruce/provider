...
#>  $ loc           : chr [1:5] "MAIN/PRIMARY HOSPITAL LOCATION" "MAIN/PRIMARY HOSPITAL LOCATION" "MAIN/PRIMARY HOSPITAL LOCATION" "OTHER HOSPITAL PRACTICE LOCATION" ...
#>  $ loc_otxt      : chr [1:5] NA NA NA "HOSPITAL - GENERAL PRACTICE AND CLINICS" ...
...
#>  $ sub_otxt      : chr [1:5] NA NA NA "ORGAN TRANSPLANT PROGRAM" ...
```
...
#> ✔ `clinicians` returned 60 results.
#> # A tibble: 60 × 25
