...
```
    ...
    #>  $ struct        : chr [1:5] "CORPORATION" "CORPORATION" "CORPORATION" "CORPORATION" ...
    #>  $ struct_otext  : chr [1:5] NA NA NA NA ...
    ...
    #>  $ location      : chr [1:5] "MAIN/PRIMARY HOSPITAL LOCATION" "MAIN/PRIMARY HOSPITAL LOCATION" "MAIN/PRIMARY HOSPITAL LOCATION" "OTHER HOSPITAL PRACTICE LOCATION" ...
    #>  $ loc_otext     : chr [1:5] NA NA NA "HOSPITAL - GENERAL PRACTICE AND CLINICS" ...
