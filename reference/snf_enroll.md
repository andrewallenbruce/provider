...
#>  $ enid_state: chr [1:10] "NC" "OK" "TN" "TN" ...
...
#>  $ inc_state : chr [1:10] "NC" NA "TN" "TN" ...
#>  $ org_type  : chr [1:10] "CORPORATION" "LLC" "LLC" "CORPORATION" ...
#>  $ org_otxt  : chr [1:10] NA NA NA NA ...
#>  $ status    : chr [1:10] "P" "P" "P" "P" ...
#>  $ nh_name   : chr [1:10] "WINDSOR POINT CONTINUING CARE" "WESTHAVEN NURSING HOME" "HILLCREST HEALTHCARE CENTER" "BELLS NURSING AND REHABILITATION CENTER" ...
...
#>  $ address   : chr [1:10] "1221 BROAD STREET" "1215 S. WESTERN, WESTERN NURSING HOME" "111  PEMBERTON                     DR" "213 HERNDON DR" ...
```
