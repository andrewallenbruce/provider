...
``` r
pending(count = TRUE)
#> ◼ pending | 14,572 rows | 4 pages

pending(first = starts("V"))
#> ✔ pending returned 219 results
#> ✔ Retrieving 2 pages
#> # A tibble: 219 × 4
...
#>  4 Physician 1932895539 VAHE      MARTIKIAN       
#>  5 Physician 1194614206 VAHID     HARBI           
#>  6 Physician 1447190517 VAIDEHI   KOTHARI         
#>  7 Physician 1629837281 VAIDEHI   PANCHAL         
#>  8 Physician 1770420010 VALBERTO  SANHA           
#>  9 Physician 1538098231 VALENTINA MENCHERO-MACHADO
#> 10 Physician 1154292712 VALERIA   SILVA           
#> # ℹ 209 more rows
```
