...
#> clia [6 × 24] (S3: clia/tbl_df/tbl/data.frame)
...
#>  $ multi     : chr [1:6] NA NA NA "Applied, Non-profit" ...
#>  $ compliance: chr [1:6] "Compliant (Survey), Eligible (CMS)" "Compliant (Survey), Eligible (CMS), Compliant (POC)" "Compliant (Survey), Eligible (CMS)" "Non-compliant (Survey), Eligible (CMS)" ...
...
#> clia [18 × 24] (S3: clia/tbl_df/tbl/data.frame)
...
#>  $ compliance: chr [1:18] "Compliant (Survey), Eligible (CMS)" "Compliant (Survey), Eligible (CMS)" NA "Compliant (Survey), Eligible (CMS)" ...
...
#> clia [3 × 24] (S3: clia/tbl_df/tbl/data.frame)
