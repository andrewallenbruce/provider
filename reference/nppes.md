...
#>  1   1.85e9      1 JOSE… DANW… MSW   Sole Pr… 18302 … primary  HESP… CA    9234…
#>  2   1.59e9      1 JOSE… DAPA… RN    NA       2160 B… primary  BRONX NY    1046…
#>  3   1.26e9      1 JOSE… DAVIS MD    NA       2140 J… primary  STUR… SD    5778…
#>  4   1.26e9      1 JOSE… DAVIS MD    NA       983075… seconda… OMAHA NE    6819…
#>  5   1.26e9      1 JOSE… DE L… M.A.… NA       1233 N… primary  WILM… CA    9074…
#>  6   1.26e9      1 JOSE… DE L… M.A.… NA       3752 A… mailing  LONG… CA    9080…
#>  7   1.84e9      1 JOSIE DAVI… ALC,… Sole Pr… 574 AZ… primary  MOBI… AL    3660…
#>  8   1.84e9      1 JOSIE DAVI… ALC,… Sole Pr… 6517 B… mailing  MOBI… AL    3669…
#>  9   1.00e9      1 JO    DEAL  MD    NA       766 LA… primary  JACK… MS    3921…
#> 10   1.00e9      1 JO    DEAL  MD    NA       6255 W… mailing  LOS … CA    9002…
#> 11   1.00e9      1 JO    DEAL  MD    NA       766 LA… primary  JACK… MS    3921…
#> 12   1.00e9      1 JO    DEAL  MD    NA       6255 W… mailing  LOS … CA    9002…
#> # ℹ 14 more variables: id_code <chr>, id_issuer <chr>, id_state <chr>,
#> #   tx_code <chr>, tx_desc <chr>, tx_license <chr>, tx_prm <int>,
#> #   tx_state <chr>, tx_grp <chr>, on_type <int>, on_name <chr>,
#> #   enum_date <date>, last_update <date>, cert_date <date>
#> 
#> $type_2
#> # A tibble: 9 × 23
#>      npi entity org_name first last  cred  sub_type address loc_type city  state
#>    <int>  <int> <chr>    <chr> <chr> <chr> <chr>    <chr>   <chr>    <chr> <chr>
#> 1 1.17e9      2 PEACH S… FAHI… SASAN DO F… NA       1414 W… primary  PHIL… PA   
#> 2 1.17e9      2 PEACH S… FAHI… SASAN DO F… NA       333 S … mailing  CHIC… IL   
#> 3 1.17e9      2 PEACH S… FAHI… SASAN DO F… NA       1414 W… primary  PHIL… PA   
#> 4 1.17e9      2 PEACH S… FAHI… SASAN DO F… NA       333 S … mailing  CHIC… IL   
#> 5 1.23e9      2 VIOS FE… KATR… MARS… Dir … NA       26400 … primary  SOUT… MI   
#> 6 1.98e9      2 VIOS FE… HANN… JOHN… Dire… NA       1455 N… primary  CHIC… IL   
#> 7 1.98e9      2 VIOS FE… HANN… JOHN… Dire… NA       2516 W… mailing  GLEN… IL   
#> 8 1.98e9      2 VIOS FE… HANN… JOHN… Dire… NA       1455 N… primary  CHIC… IL   
#> 9 1.98e9      2 VIOS FE… HANN… JOHN… Dire… NA       2516 W… mailing  GLEN… IL   
#> # ℹ 12 more variables: zip <chr>, tx_code <chr>, tx_desc <chr>,
