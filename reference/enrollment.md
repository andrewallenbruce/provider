...
#> tibble [768 × 14] (S3: tbl_df/tbl/data.frame)
...
#>  $ address : chr [1:768] "911 S MAIN ST" "1830 N MAIN ST" "STE 200" "2814 14TH AVE SE" ...
...
#> tibble [312 × 14] (S3: tbl_df/tbl/data.frame)
...
#>  $ address : chr [1:312] "1095 WHIPPOORWILL LN" "STE 100" "STE 100" "SUITE 401" ...
...
#> tibble [220 × 14] (S3: tbl_df/tbl/data.frame)
...
#>  $ address : chr [1:220] "10762 S US HIGHWAY 441" "STE A" "SUITE 4" "21W MAIN AVE" ...
...
#> tibble [1,044 × 16] (S3: tbl_df/tbl/data.frame)
