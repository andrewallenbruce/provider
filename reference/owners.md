...
#> fqhc_wnr [254 × 19] (S3: fqhc_owner/tbl_df/tbl/data.frame)
...
#> hsptl_wn [137 × 19] (S3: hospital_owner/tbl_df/tbl/data.frame)
...
#>  $ address : chr [1:137] "6899 COLLINS AVENUE, UNIT 2103" "201 DOWMAN DR NE" "691 CHERRY ST, STE 700" "770 HEMLOCK ST, STE A" ...
...
#>  $ own_type: chr [1:137] NA "LLC" "Corporation, Non-Profit" "Corporation, Non-Profit" ...

hospice_owner(state = c("GA", "FL")) |> str()
#> ✔ hospice_owner returned 1,961 results.
#> hspc_wnr [1,961 × 19] (S3: hospice_owner/tbl_df/tbl/data.frame)
...
#>  $ address : chr [1:1961] "1350 WALTON WAY" "200 GALLERIA PKWY SE, STE 1800" "4790 NORTH STATE ROAD 7" "770 HEMLOCK ST, STE A" ...
...
#>  $ own_type: chr [1:1961] "Corporation, Chain, Another Org/Ind" "OTHER: LIMITED PARTNERSHIP" NA "Corporation, Non-Profit" ...

rhc_owner(state = c("GA", "FL")) |> str()
#> ✔ rhc_owner returned 136 results.
#> rhc_ownr [136 × 19] (S3: rhc_owner/tbl_df/tbl/data.frame)
...
#>  $ address : chr [1:136] "209 N CUTHBERT ST" "770 HEMLOCK ST, STE A" "13 CORPORATE BLVD NE, STE 100" "13 CORPORATE BLVD NE, STE 100" ...
...
#>  $ own_type: chr [1:136] "OTHER: GOV'T ENTITY" "Corporation, Non-Profit" "LLC, For-Profit" "LLC, For-Profit" ...

snf_owner(state = c("GA", "FL")) |> str()
#> ✔ snf_owner returned 4,175 results.
#> snf_ownr [4,175 × 19] (S3: snf_owner/tbl_df/tbl/data.frame)
...
#>  $ address : chr [1:4175] "1571 BOWMAN HWY" "1571 BOWMAN HWY" "ONE RAVINA DRIVE, SUITE 1500" "8601 DUNWOODY PL, STE 775" ...
...
#>  $ own_type: chr [1:4175] NA NA "Acquisition, LLC" "Acquisition, LLC" ...
```
