...
#> ✔ hha_owner returned 1,799 results.
#> hha_ownr [1,799 × 19] (S3: hha_owner/tbl_df/tbl/data.frame)
#>  $ org_enid: chr [1:1799] "O20080922000171" "O20080515000169" "O20080515000169" "O20220110002706" ...
#>  $ org_pac : chr [1:1799] "8527135367" "0042389132" "0042389132" "5799177473" ...
#>  $ org_name: chr [1:1799] "ORLANDO INTERIM ACQUISITION COMPANY, LLC" "APOGEE HEALTH CARE INC." "APOGEE HEALTH CARE INC." "ILS HHA OF PALM BEACH LLC" ...
#>  $ pac     : chr [1:1799] "0042387896" "0042389132" "0042389132" "0042520280" ...
#>  $ role    : chr [1:1799] "5% OR GREATER DIRECT OWNERSHIP INTEREST" "5% OR GREATER DIRECT OWNERSHIP INTEREST" "OPERATIONAL/MANAGERIAL CONTROL" "5% OR GREATER INDIRECT OWNERSHIP INTEREST" ...
#>  $ asc_date: Date[1:1799], format: "2009-04-20" "2009-12-01" ...
#>  $ own_name: chr [1:1799] "INTERIM OF CENTRAL FLORIDA LLC" "APOGEE HEALTH CARE INC." "APOGEE HEALTH CARE INC." "OAK ILS BLOCKER CORP" ...
#>  $ own_dba : chr [1:1799] NA "APOGEE HOME HEALTH" "APOGEE HOME HEALTH" NA ...
#>  $ percent : num [1:1799] 100 NA NA 24.8 23.9 ...
#>  $ entity  : chr [1:1799] "O" "O" "O" "O" ...
#>  $ title   : chr [1:1799] NA NA NA NA ...
#>  $ first   : chr [1:1799] NA NA NA NA ...
#>  $ middle  : chr [1:1799] NA NA NA NA ...
#>  $ last    : chr [1:1799] NA NA NA NA ...
#>  $ address : chr [1:1799] "1890 STATE ROAD 436, SUITE 300" "15127 S JOG RD, STE 202" "15127 S JOG RD, STE 202" "4601 NW 77TH AVE" ...
#>  $ city    : chr [1:1799] "WINTER PARK" "DELRAY BEACH" "DELRAY BEACH" "MIAMI" ...
#>  $ state   : chr [1:1799] "FL" "FL" "FL" "FL" ...
#>  $ zip     : chr [1:1799] "327922285" "334461251" "334461251" "331666449" ...
#>  $ own_type: chr [1:1799] "LLC" "Corporation, For-Profit" "Corporation, For-Profit" "Corporation, For-Profit" ...
```
